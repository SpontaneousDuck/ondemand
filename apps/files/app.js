...
app.use(cloudcmd({
    ...
    config: {                         /* config data (optional)                                   */
        ...
        upload_max:             parseInt(process.env.FILE_UPLOAD_MAX) <= parseInt(process.env.NGINX_FILE_UPLOAD_MAX) ? parseInt(process.env.FILE_UPLOAD_MAX) : parseInt(process.env.NGINX_FILE_UPLOAD_MAX) || 10485760000,
